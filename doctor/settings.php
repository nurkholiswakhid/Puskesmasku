                                    ...
                                    <div  class="dashboard-items setting-tabs"  style="padding:20px;margin:auto;width:95%;display: flex">
                                        ...
                                        <div>
                                                ...
                                                <div class="h3-dashboard" style="font-size: 15px;">
                                                    Edit Detail Akun Anda & Ganti Kata Sandi
                                                </div>
                                        </div>
        ...
        if($action=='drop'){
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <a href="delete-doctor.php?id='.$id.'" class="non-style-link"><button  class="btn-primary btn"  style="display: flex;justify-content: center;align-items: center;margin:10px;padding:10px;"<font class="tn-in-text">&nbsp;Iya&nbsp;</font></button></a>&nbsp;&nbsp;&nbsp;
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <table width="80%" class="sub-table scrolldown add-doc-form-container" border="0">
                            ...
                            <tr>
                                <td>
                                    <p style="padding: 0;margin: 0;text-align: left;font-size: 25px;font-weight: 500;">Melihat rincian.</p><br><br>
                                </td>
                            </tr>
            ...
            $error_1=$_GET["error"];
                $errorlist= array(
                    ...
                    '2'=>'<label for="promter" class="form-label" style="color:rgb(255, 62, 62);text-align:center;">Kesalahan konformasi kata sandi!</label>',
                    ...
                    <div id="popup1" class="overlay">
                            ...
                            <center>
                                ...
                                <tr>
                                    ...
                                    <tr>
                                        <td>
                                            <p style="padding: 0;margin: 0;text-align: left;font-size: 25px;font-weight: 500;">editDetailDokter.</p>
                                        Doctor ID : '.$id.' <br><br>
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td class="label-td" colspan="2">
                                            <input type="text" name="nic" class="input-text" placeholder="NIP" value="'.$nic.'" required><br>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="label-td" colspan="2">
                                    ...
                                    <tr>
                                        <td class="label-td" colspan="2">
                                            <label for="spec" class="form-label">Spesialis: (Current'.$spcil_name.')</label>
