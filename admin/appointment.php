            ...
            <table class="menu-container" border="0">
                ...
                <tr class="menu-row">
                    <td class="menu-btn menu-icon-appoinment menu-active menu-icon-appoinment-active">
                        <a href="appointment.php" class="non-style-link-menu non-style-link-menu-active"><div><p class="menu-text">Janji Temu</p></a></div>
                    </td>
                </tr>
                <tr class="menu-row" >
        ...
        <div class="dash-body">
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;margin-top:25px; ">
                <tr >
                    ...
                    <td>
                        <p style="font-size: 23px;padding-left:12px;font-weight: 600;">Janji Temu</p>
    ...
    if($_GET){
        ...
        if($action=='add-session'){
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        echo     '       </select><br><br>
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <input type="number" name="nop" class="input-text" min="0"  placeholder="Nomor akhir janji untuk sesi ini tergantung pada jumlah ini" required><br>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                    <br><br>
                        <h2>Sesi Ditambahkan.</h2>
                        <a class="close" href="schedule.php">&times;</a>
                        <div class="content">
                        '.substr($titleget,0,40).' telah dijadwalkan pada jadwal baru.<br><br>
                        <a href="schedule.php"><button  class="login-btn btn-primary-soft btn"  style="display: flex;justify-content: center;align-items: center;margin-left:20px;">&nbsp; Kembali &nbsp;</font></button></a>
                        </div>
                        <br><br>
                    </center>
            </div>
            ...
            $nameget=$_GET["name"];
            $sessionget=$_GET["session"];
            $apponumget=$_GET["apponum"];
            $appoid=$_GET["id"];
            echo '
            <div id="popup1" class="overlay">
                    <div class="popup">
                    ...
                    <br><br>
                        ...
                        <div class="content">
                        Apakah Anda yakin ingin membatalkan pesanan pasien '.substr($nameget,0,25).' untuk sesi '.substr($sessionget,0,25).' dengan nomor Janji #'.$apponumget.'? <br><br>
                        <a href="drop.php?id='.$appoid.'"><button  class="login-btn btn-primary-soft btn"  style="display: flex;justify-content: center;align-items: center;margin-left:20px;">&nbsp; Iya, Batalkan &nbsp;</font></button></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <a href="appointment.php"><button  class="login-btn btn-primary-soft btn"  style="display: flex;justify-content: center;align-items: center;margin-left:20px;">&nbsp; Tidak, Kembali &nbsp;</font></button></a>
                        </div>
                        <br><br>
                    </center>
            </div>
            ...
            <div id="popup1" class="overlay">
                    ...
                    <br><br>
                        ...
                        <a class="close" href="appointment.php">&times;</a>
                        <div class="content">
                        Pesanan Pasien '.substr($nameget,0,25).' berhasil dibatalkan. <br><br>
                        <a href="appointment.php"><button  class="login-btn btn-primary-soft btn"  style="display: flex;justify-content: center;align-items: center;margin-left:20px;">&nbsp; Kembali &nbsp;</font></button></a>
                        </div>
                        <br><br>
                    </center>
            </div>
