...
<body>
    ...
    <div class="container">
        ...
        <table class="menu-container" border="0">
                ...
                <tr class="menu-row" >
                    <td class="menu-btn menu-icon-settings-active">
                        <a href="settings.php" class="non-style-link-menu-active"><div><p class="menu-text">Pengaturan</p></a></div>
                    </td>
                </tr>
                                    ...
                                    <div  class="dashboard-items setting-tabs"  style="padding:20px;margin:auto;width:95%;display: flex">
                                        ...
                                        <div>
                                                ...
                                                <div class="h3-dashboard" style="font-size: 15px;">
                                                    Edit Detail Akun & Ganti Kata Sandi
                                                </div>
                                        </div>
                            ...
                            <td style="width: 25%;">
                                    ...
                                    <div  class="dashboard-items setting-tabs"  style="padding:20px;margin:auto;width:95%;display: flex;">
                                        ...
                                        <div>
                                                ...
                                                <div class="h3-dashboard"  style="font-size: 15px;">
                                                    Lihat Informasi Pribadi Tentang Akun Anda
                                                </div>
                                        </div>
        ...
        if($action=='drop'){
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <a href="delete-account.php?id='.$id.'" class="non-style-link"><button  class="btn-primary btn"  style="display: flex;justify-content: center;align-items: center;margin:10px;padding:10px;"<font class="tn-in-text">&nbsp;Iya&nbsp;</font></button></a>&nbsp;&nbsp;&nbsp;
        ...
        <center>
            ...
            <div style="display: flex;justify-content: center;">
                <table width="80%" class="sub-table scrolldown add-doc-form-container" border="0">
                    <tr>
                        <td>
                            <p style="padding: 0;margin: 0;text-align: left;font-size: 25px;font-weight: 500;">Lihat Details</p><br>
                        </td>
                    </tr>
                    <tr>
        ...
        <br><br>
                                        ...
                                        <table width="80%" class="sub-table scrolldown add-doc-form-container" border="0">
                                            ...
                                            <tr>
                                                <td>
                                                    ...
                                                    ID Pengguna: '.$id.' (Auto Dibuat)<br><br>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="label-td" colspan="2">
                                            ...
                                            <tr>
                                                <td class="label-td" colspan="2">
                                                    <input type="text" name="name" class="input-text" placeholder="Nama Pengguna" value="'.$name.'" required><br>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="label-td" colspan="2">
                                            ...
                                            <tr>
                                                <td class="label-td" colspan="2">
                                                    <input type="text" name="nic" class="input-text" placeholder="Nomor KTP" value="'.$nic.'" required><br>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="label-td" colspan="2">
                                            ...
                                            <tr>
                                                <td class="label-td" colspan="2">
                                                    <input type="password" name="password" class="input-text" placeholder="Buat Kata Sandi" required><br>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="label-td" colspan="2">
                                            ...
                                            <tr>
                                                <td class="label-td" colspan="2">
                                                    <input type="password" name="cpassword" class="input-text" placeholder="Konfirmasi Kata Sandi" required><br>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td colspan="2">
            ...
            <div id="popup1" class="overlay">
                <div class="popup">
                    <center>
                        <br><br><br><br>
                        <h2>Berhasil Diedit!</h2>
                        <a class="close" href="settings.php">&times;</a>
                        <div class="content">
                            Jika Anda mengubah alamat email Anda, silakan logout dan login kembali dengan alamat email baru.
                        </div>
                        <div style="display: flex;justify-content: center;">
                            ...
                            <a href="../logout.php" class="non-style-link">
                                <button class="btn-primary-soft btn" style="display: flex;justify-content: center;align-items: center;margin:10px;padding:10px;">
                                    <font class="tn-in-text">&nbsp;&nbsp;Keluar&nbsp;&nbsp;</font>
                                </button>
                            </a>
                        </div>
                        <br><br>
