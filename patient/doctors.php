    ...
    <body>
        ...
        <div class="container">
            ...
            <table class="menu-container" border="0">
                    ...
                    <tr class="menu-row">
                        <td class="menu-btn menu-icon-doctor-active">
                            <a href="doctors.php" class="non-style-link-menu-active"><div><p class="menu-text">Dokter</p></a></div>
                        </td>
                    </tr>
                            ...
                            <tbody>
                                ...
                                <?php
                                    ...
                                    if($result->num_rows==0){
                                        ...
                                        <a class="non-style-link" href="doctors.php"><button  class="login-btn btn-primary-soft btn"  style="display: flex;justify-content: center;align-items: center;margin-left:20px;">&nbsp; Tampilkan Semua Daftar Dokter &nbsp;</font></button>
                                        </a>
                                        </center>
                                        <br><br><br><br>
                                        </td>
                                    ...
                                    for ( $x=0; $x<$result->num_rows;$x++){
                                        ...
                                        &nbsp;&nbsp;&nbsp;
                                        <a href="?action=session&id='.$docid.'&name='.$name.'"  class="non-style-link"><button  class="btn-primary-soft btn button-icon menu-icon-session-active"  style="padding-left: 40px;padding-top: 12px;padding-bottom: 12px;margin-top: 10px;"><font class="tn-in-text">Jadwal</font></button></a>
                                            </div>
                                            </td>
                                        </tr>';
            ...
            if($action=='drop'){
                ...
                <div id="popup1" class="overlay">
                        ...
                        <center>
                            ...
                            <div style="display: flex;justify-content: center;">
                            <table width="90%" class="sub-table scrolldown add-doc-form-container" >
                            
                                <tr>
                                    <td>
                                        <p style="padding: ;margin: 0;text-align: left;font-size: 25px;font-weight: 500;">Data Dokter</p><br><br>
                                    </td>
                                </tr>
                ...
                <div id="popup1" class="overlay">
                        ...
                        <center>
                            <h2>Alihkan Ke Jadwal Dokter?</h2>
                            <a class="close"  href="doctors.php">&times;</a>
                            <div class="content">
                                Anda ingin melihat Semua Jadwal <br>Dr. '.substr($name,0,40).'.
                            ...
                            <input type="submit"  value="Iya" class="btn-primary btn"   >
