...
?>
    ...
    <div class="container">
        <table border="0">
            ...
            <tr>
                <td class="label-td" colspan="2">
                    <input type="text" name="nic" class="input-text" placeholder="Nomor Induk Kependudukan" required>
                </td>
            </tr>
            <tr>
                <td class="label-td" colspan="2">
            ...
            <tr>
                <td>
                    <input type="reset" value="Bersihkan" class="login-btn btn-primary-soft btn" >
                </td>
                <td>
                    <input type="submit" value="Selanjutnya" class="login-btn btn-primary btn">
                </td>
